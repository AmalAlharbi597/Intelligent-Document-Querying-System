...
module "bedrock_kb" {
  ...
  aurora_arn        = "arn:aws:rds:us-east-1:704448598553:cluster:my-aurora-serverless" # FILLED
  aurora_db_name    = "ISQSDATA"
  aurora_endpoint   = "my-aurora-serverless.cluster-c89k4w88skvu.us-east-1.rds.amazonaws.com" # FILLED
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-east-1:704448598553:secret:my-aurora-serverless-sgKrJh" # FILLED
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-704448598553" # FILLED
}